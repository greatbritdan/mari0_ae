...
entitydescriptions = {
	...
	"jumps around", --"thwimp",
	"walks back and forth, can retract into shell and grow spikes, collapses when stomped", --"drybeetle",
	"walks back and forth, can retract into shell and grow spikes, collapses when stomped", --"drybeetlehalf",
	...
	"jumps around, gives a shoe when stomped, allows stomping and safe walking on spikes/munchers", --"goombashoe",
	...
	"when collected gets added to the players hud, can be used to trigger collectable locks", --"collectable",
